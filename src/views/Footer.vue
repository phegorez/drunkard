<template>
    <footer class="bg-[#202235] lg:p-20 sm:p-6">
        <div class="flex justify-center lg:flex-row sm:flex-col lg:gap-64 sm:gap-20">
            <div class="flex lg:flex-row sm:flex-col lg:gap-20 sm:gap-10">
                <div class="flex flex-col gap-6">
                    <div class="font-bold text-[1.25rem] sm:hidden lg:block">
                        <span class="text-[#8EFFC9]">Drunkard</span> <span class="text-white">Remiex</span>
                    </div>
                    <div class="font-bold text-[0.875rem] sm:block lg:hidden">
                        <span class="uppercase text-white sm:block lg:hidden">FOLLOW Developer</span>
                    </div>

                    <div class="flex lg:justify-between sm:gap-4">
                        <div class="sm:border lg:border-none sm:p-3 lg:p-0 sm:rounded-md lg:rounded-none cursor-pointer">
                    ...
                    <h4 class="text-white sm:hidden lg:block">(+994) 199-28-786</h4>
                </div>

                <div class="flex lg:flex-row sm:flex-col gap-20">
                    <div class="flex flex-col gap-4">
                        <h2 class="font-bold text-white text-lg">Drunkard Navigation</h2>
                        <ul class="flex flex-col gap-4">
                            <li class="text-white">Home</li>
                            <li class="text-white">Recipes</li>
                            <li class="text-white">Cocktail Language</li>
                            <li class="text-white">Recommend</li>
                        </ul>
                    </div>
                    <div class="flex flex-col gap-4 sm:hidden lg:block">
                        <h2 class="font-bold text-white text-lg">About us</h2>
                        <ul class="flex flex-col gap-4">
                            <li class="text-white">Login</li>
                            <li class="text-white">Sign Up</li>
            ...
            <div class="flex flex-col gap-5">
                <h2 class="font-bold text-white text-lg">Subscribe Our News Letter</h2>
                <p class="w-96 text-white">Sure, please provide your email address to subscribe to newsletter</p>
                <div class="lg:border rounded-md flex lg:flex-row sm:flex-col sm:gap-8 lg:gap-0">
                    <input type="text" placeholder="Enter your mail..." class="input">
                    <button
                        class="bg-[#3DDEED] p-4 border-none lg:ml-[1.5rem] lg:rounded-r-sm sm:rounded-sm font-bold">Subscribe</button>
                </div>
            </div>
        </div>
        <p class="text-center lg:my-16 sm:my-6 text-white sm:text-[0.75rem] lg:text-[1rem]">© 2023 Your Company Name. All rights reserved.</p>
    </footer>
</template>
<script setup>
